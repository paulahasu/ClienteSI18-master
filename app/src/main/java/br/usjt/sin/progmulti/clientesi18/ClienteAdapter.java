...
public class ClienteAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ImageView foto = (ImageView)linha.findViewById(R.id.foto_cliente);
        TextView linha_nome = (TextView)linha.findViewById(R.id.linha_nome);
       TextView  linha_detalhe = (TextView)linha.findViewById(R.id.linha_detalhe);
